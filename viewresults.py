...
num_train = 0
with open('train_test_split/training_data.md', 'r') as file:
    for line in file.readlines():
        if '-' in line:
            num_train += 1
num_test = 0
with open('train_test_split/test_data.md', 'r') as file:
    for line in file.readlines():
        if '-' in line:
            num_test += 1

st.markdown("Results Summary")
st.markdown("Train: {}, Test: {}".format(num_train, num_test))
